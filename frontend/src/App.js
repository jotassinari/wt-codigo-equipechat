    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#b30e16" },
                textPrimary: mode === "light" ? "#B30E16" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#B30E16" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#B30E16" : "#fff",
                ...
                //barraSuperior: mode === "light" ? "linear-gradient(to right, #B30E16, #0000FF, #00008B)" : "#666",
                barraSuperior: mode === "light" ? "linear-gradient(to right, #b92626, #e54848, #0e0e0e)" : "#666",
